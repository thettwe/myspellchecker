...
The v2.0 pure-spelling release, shipping as a backward-compatible `1.10.0` (the public API is unchanged). It focuses on Myanmar spelling detection: several hard error classes are now detected and enabled by default.
